...
import RequestBooking1 from '../Hotels_/RequestBooking1';
import RequestBooking2 from '../Hotels_/RequestBooking2';
import RequestBooking4 from '../Hotels_/RequestBooking4';
import RequestBooking5 from '../Hotels_/RequestBooking5';
import RequestBooking3 from './RequestBooking3';
  ...
  const renderBookingStep = () => {
    switch (currentStep) {
      ...
      case 3:
        return <RequestBooking3 onNext={handleNextStep} vehicleInfo={vehicleInfo}/>;
        case 4:
          return <RequestBooking4 onNext={handleNextStep} vehicleInfo={vehicleInfo}/>;
          case 5:
            return <RequestBooking5 onNext={handleNextStep} vehicleInfo={vehicleInfo}/>;
        case 6:
        return <VehicleSearchFilter onNext={handleNextStep} />;
      default:
        return <RequestBooking1 onNext={handleNextStep} />;
            ...
            <View style={styles.buttonContainer}>
              <View style={styles.nextButtonContainer}>
                <TouchableOpacity onPress={handleRequestBooking}>
                  <Text style={styles.buttonTxt}>See Availability</Text>
                </TouchableOpacity>
              </View>
