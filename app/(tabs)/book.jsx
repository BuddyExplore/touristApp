...
export default function book() {
  ...
  return (
    ...
    >
      <TouchableOpacity
        onPress={() => router.push("/Booking/Vehicles/search")}
        style={{
          marginVertical: 10,
          flexDirection: "row",
          alignItems: "center",
      ...
      >
        <View>
          <Image
            ...
            source={require("../../assets/images/BookingCard/vehicle.png")}
          />
        </View>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, flexWrap: "wrap" }}>
            Book vehicles with drivers who can drive you to your destination
          </Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity
        onPress={() => router.push("/Booking/Tourguides/search")}
        style={{
          marginVertical: 10,
          flexDirection: "row",
          alignItems: "center",
      ...
      >
        <View>
          <Image
            style={{ height: 70, width: 70 }}
            source={require("../../assets/images/BookingCard/guide.png")}
          />
        </View>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, flexWrap: "wrap" }}>
            Book experienced tour guides who can guide you during your journey
          </Text>
        </View>
      </TouchableOpacity>

      <TouchableOpacity
        onPress={() => router.push("/Booking/Hotels/search")}
        style={{
          marginVertical: 10,
          flexDirection: "row",
          alignItems: "center",
      ...
      >
        <View>
          <Image
            style={{ height: 70, width: 70 }}
            source={require("../../assets/images/BookingCard/hotel.png")}
          />
        </View>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, flexWrap: "wrap" }}>
            Book comfortable hotels that provide excellent services during your
            stay
          </Text>
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity onPress={() => router.push('/Booking/Items') } style={{marginVertical: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: "#F3F3F3", paddingVertical: 25, paddingHorizontal: 25, borderRadius: 30}}>
        <View>
          <Image
            style={{ height: 70, width: 70 }}
            source={require("../../assets/images/BookingCard/shop.png")}
          />
        </View>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, flexWrap: "wrap" }}>
            Shop from stores that offer a wide range of items for all your
            needs.
          </Text>
        </View>
      </TouchableOpacity>
      ...
      >
        <View>
          <Image
            style={{ height: 70, width: 70 }}
            source={require("../../assets/images/BookingCard/activity.png")}
          />
        </View>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, flexWrap: "wrap" }}>
            Book exciting activities around the island which enhance your travel
            experience.
          </Text>
        </View>
      </TouchableOpacity>
